...
!(function () {
  ...
  function M(t) {
    ...
    for (n in ((i = Array.isArray(s) ? [] : {}), s))
      s.hasOwnProperty(n) && ((h = s[n]), (i[n] = h && "object" == typeof h ? M(h) : h));
    return i;
  }
  function b(t) {
    return null !== t;
  ...
  function A(t) {
    var i,
      n = (function (t) {
        var i;
        if (((t = t.toLowerCase()) in C && (t = C[t]), (i = B.exec(t) || L.exec(t))))
          return [D(parseInt(i[1], 10)), D(parseInt(i[2], 10)), D(parseInt(i[3], 10))];
        if ((i = E.exec(t))) return [D(parseInt(i[1], 16)), D(parseInt(i[2], 16)), D(parseInt(i[3], 16))];
        if ((i = T.exec(t)))
          return [D(17 * parseInt(i[1], 16)), D(17 * parseInt(i[2], 16)), D(17 * parseInt(i[3], 16))];
        throw new Error("Cannot parse color: " + t);
      })(t);
    return {
      yt: "rgb(" + n[0] + ", " + n[1] + ", " + n[2] + ")",
      kt: ((i = n), 0.199 * i[0] + 0.687 * i[1] + 0.114 * i[2] > 160 ? "black" : "white"),
    };
  }
  ...
  var P,
          ...
          if (this.it.Y) {
            ...
            if (((t.fillStyle = this.xt.yt), (t.lineWidth = 1), (t.lineCap = "butt"), c)) {
              ...
              t.save(),
                ...
                this.it.St && ((t.fillStyle = this.xt.ut), t.fillRect(T, B, V - T, C)),
                (t.textAlign = "left"),
          ...
          if (null !== this.it && !1 !== this.it.Y && 0 !== this.it.Vt.length) {
            ...
            if (!(s <= 0)) {
              ...
              f < 0
                ...
                : f + e > a && ((o -= Math.abs(a - (f + e))), (f = Math.floor(o - u) + 0.5));
              var c = f + e,
    ...
    U = (function () {
      function t(t, i, n) {
        (this.Ut = !0),
          (this.lt = new j()),
          (this.ot = { Y: !1, yt: "#4c525e", ut: "white", Vt: "", wt: 0, Ft: NaN }),
          (this.A = t),
          (this.ri = i),
          (this.ti = n);
      }
  ...
  var H = (function (t) {
      ...
      return (
        ...
        (i.prototype.qi = function (t, i, n) {
          ...
          return (
            null !== a && null !== o ? ((this.Mi = i), (this.ki = a.Z(i, o))) : ((this.Mi = NaN), (this.ki = NaN)),
            h !== this.yi || s !== this.ki || e !== this.bi || r !== this.Mi || u !== this.wi
          );
        }),
  ...
  var $ = (function () {
      ...
      return (
        ...
        (t.prototype.$i = function () {
          if (((this.Zi = 0), this.Qt > 0 && this.Ki > 0)) for (var t = this.Qt; t > 1; ) (t /= 10), this.Zi++;
        }),
      ...
      return (
        (t.prototype.kn = function (t, i, n) {
          ...
          if (
            (a <= e + u && (a = e),
            (a = Math.max(1, a)),
            this.yn.length > 0 && ((h = a), (s = 1), (r = u), Math.abs(h - s) < r))
          )
      ...
      return (
        ...
        (t.prototype.Dn = function () {
          ...
          if (null !== i) {
            ...
            if (a !== o) {
              for (
                var l = this.kn(a, o), f = a % l, c = a >= o ? 1 : -1, v = null, _ = 0, d = a - (f += f < 0 ? l : 0);
                d > o;
                d -= l
              ) {
                var w = this.Sn(d, i, !0);
    ...
    Mt = (function () {
      ...
      return (
        ...
        (t.prototype.ah = function () {
          return { dh: this.Si.autoScale, wh: this.Si.invertScale, ah: this.Si.mode };
        }),
        (t.prototype.uh = function (t) {
          ...
          void 0 !== t.dh && (this.Si.autoScale = t.dh),
            void 0 !== t.ah &&
              ((this.Si.mode = t.ah), (2 !== t.ah && 3 !== t.ah) || (this.Si.autoScale = !0), (this.In.Wn = !1)),
            1 === i.ah &&
              t.ah !== i.ah &&
              (!(function (t) {
                if (null === t) return !1;
            ...
            1 === t.ah && t.ah !== i.ah && null !== (n = ot(this.Pn)) && this.Mh(n);
          var h = i.ah !== this.Si.mode;
          h && (2 === i.ah || this.fh()) && this.eh(),
            h && (3 === i.ah || this._h()) && this.eh(),
            void 0 !== t.wh && i.wh !== t.wh && ((this.Si.invertScale = t.wh), this.bh()),
        ...
        (t.prototype.Fh = function (t) {
          ...
          this.Yn.splice(i, 1), 0 === this.Yn.length && (this.uh({ dh: !0 }), this.Mh(null)), this.eh(), this.Ph();
        }),
        ...
        (t.prototype.Rh = function (t) {
          this.fh() ||
            ...
            (null === this.Xn &&
              null === this.Fn &&
              (this.ii() || ((this.Xn = this.On - t), (this.Fn = l(this.xh()).fn()))));
        }),
        ...
        (t.prototype.qh = function (t) {
          this.lh() ||
            (null === this.Zn && null === this.Fn && (this.ii() || ((this.Zn = t), (this.Fn = l(this.xh()).fn()))));
        }),
        ...
        (t.prototype.ns = function () {
          ...
          if (null !== t) {
            ...
            if (
              ((n === this.jn && h === this.Un) || ((this.jn = n), (this.Un = h), (this.$n = null), this.oh()),
              null !== i)
            ) {
              if (i.cn() === i.vn()) {
                var c = this.Zh(),
  ...
  function bt(t) {
    void 0 !== t.borderColor && ((t.borderUpColor = t.borderColor), (t.borderDownColor = t.borderColor)),
      void 0 !== t.wickColor && ((t.wickUpColor = t.wickColor), (t.wickDownColor = t.wickColor));
  }
  !(function (t) {
        ...
        (t.prototype.ls = function (t) {
          var i =
              void 0 === t.Cs
                ...
                : new Date(Date.UTC(t.Cs.year, t.Cs.month - 1, t.Cs.day)).getTime(),
            n = this.ks.get(i);
    ...
    Tt = (function () {
      ...
      return (
        ...
        (t.prototype.Ws = function (t, i) {
          var n = Math.ceil(i / t);
          return (null !== this.ks && this.ks.Rs === n) || (this.ks = { Vn: this.js(n), Rs: n }), this.ks.Vn;
        }),
        (t.prototype.js = function (t) {
          for (
            ...
            if (this.Os.get(s)) {
              ...
              i = [];
              for (
                var e = r.length, u = 0, a = o(this.Os.get(s)), l = a.length, f = 1 / 0, c = -1 / 0, v = 0;
                v < l;
                v++
              ) {
    ...
    return (
      ...
      (t.prototype.rh = function (t, i) {
        ...
        c(this.Si, t),
          ...
          void 0 !== t.minBarSpacing && this.ri.dr(null !== (n = t.barSpacing) && void 0 !== n ? n : this.ur),
          this.cr(),
          this.ar(),
          this.nr.rn();
      }),
        ...
        for (
          ...
          if (s <= o.Fs && o.Fs <= r) {
            ...
            if (null !== f) {
              ...
              } else this.rr.push({ En: this.tt(o.Fs), Ln: this.Wr(f, o.Is), Is: o.Is });
              e++;
            }
          }
        }
      ...
      (t.prototype.ee = function () {
        ...
        return null === t || null === i
          ? null
          : t - i - 1 + (this.Si.fixLeftEdge ? this.Ks / this.ur : Math.min(2, this.Xs.length));
      }),
      ...
      (t.prototype.ue = function (t, i) {
        ...
        return (
          (h =
            i < 20 && s ? (this.Si.secondsVisible ? 4 : 3) : i < 40 && s ? 3 : i < 50 || i < 60 ? 2 : i < 70 ? 1 : 0),
          void 0 !== this.Si.tickMarkFormatter
            ? this.Si.tickMarkFormatter(null !== (n = t.Cs) && void 0 !== n ? n : t.Ds, h, this.th.locale)
            : (function (t, i, n) {
                var h = {};
                switch (i) {
                  case 0:
                ...
                var s =
                  void 0 === t.Cs ? new Date(1e3 * t.Ds) : new Date(Date.UTC(t.Cs.year, t.Cs.month - 1, t.Cs.day));
                return new Date(
                  s.getUTCFullYear(),
                  s.getUTCMonth(),
                  s.getUTCDate(),
  ...
  var zt = (function () {
    function t(t) {
      (this.ae = { Tt: 1, Dt: 4, Pt: NaN, Nt: "", oe: "", ut: "", Lt: 0, Bt: 0, At: 0, Et: 0, zt: 0 }), (this.B = t);
    }
    return (
      (t.prototype.I = function () {
        var t = this.ae,
  ...
  var Ft = (function () {
      ...
      return (
        (t.prototype.Me = function (t, i) {
          var n = (function (t, i) {
            return void 0 === t ? i : { be: Math.max(t.be, i.be), dh: t.dh || i.dh };
          })(this.ve.get(t), i);
          this.ve.set(t, n);
        }),
    ...
    It = (function () {
      ...
      return (
        ...
        (t.prototype.De = function (t) {
          ...
          return (
            (t = Math.round(t * i) / i) >= 1e-15 && t < 1 ? t.toFixed(this.Ce).replace(/\.?0+$/, "") : String(t)
            ...
            if (
              ...
              t.moveTo(this.v.m[this.v.M.from].g, this.v.Ee),
                ...
                this.v.M.to > this.v.M.from &&
                  (t.lineTo(this.v.m[this.v.M.to - 1].g, this.v.Ee), t.lineTo(this.v.m[this.v.M.from].g, this.v.Ee));
            t.closePath();
      ...
      return (
        ...
        (t.prototype.h = function (t, i, n, h) {
          if (null !== this.it && 0 !== this.it.Yi.length && null !== this.it.M) {
            ...
            for (
              var s = null, r = this.nu <= this.iu && this.it.Fr >= Math.floor(1.5 * i), e = this.it.M.from;
              e < this.it.M.to;
              ++e
            ) {
              var u = this.it.Yi[e];
    ...
    Qt = (function (t) {
      ...
      return (
        ...
        (i.prototype.W = function (t, i) {
          ...
          var n = this.Ie.I();
          this.je();
          var h = { Yi: this.Pe, Fr: this.We.q().Fr(), ru: n.openVisible, su: n.thinBars, M: this.Fe };
        ...
        (t.prototype.cu = function (t, i, n, h, s) {
          if (null !== this.it)
            for (var r = "", e = this.vu(s), u = null, a = n.from; a < n.to; a++) {
              ...
              if ((null !== u && ((l = Math.max(u + 1, l)), (l = Math.min(l, f))), this.it.Fr * s > 2 * e))
    ...
    ii = (function (t) {
      ...
      return (
        ...
        (i.prototype.W = function (t, i) {
          ...
          var n = this.Ie.I();
          this.je();
          var h = { Yi: this.Pe, Fr: this.We.q().Fr(), ou: n.wickVisible, fu: n.borderVisible, M: this.Fe };
          return this.lt._(h), this.lt;
        }),
        (i.prototype.He = function () {
          var t = this;
        ...
        (t.prototype.h = function (t, i, n, h) {
          if (null !== this.it && 0 !== this.it.m.length && null !== this.it.M) {
            ...
            for (
              ...
              var f = void 0,
                c = void 0;
              l <= r ? ((f = l), (c = e)) : ((f = r), (c = l - Math.floor(s / 2) + s)),
        ...
        (t.prototype.mu = function (t) {
          if (null !== this.it && 0 !== this.it.m.length && null !== this.it.M) {
            ...
            for (var h = this.it.M.from; h < this.it.M.to; h++) {
              ...
              this.bu[h - this.it.M.from] = { ss: u, rs: a, pu: e, yu: r.g * t, P: r.P };
            }
  ...
  var ri = (function (t) {
    ...
    ci = (function () {
      function t(t) {
        (this.Pu = { wt: 0, Mt: 0, p: 0, ut: "rgba(0, 0, 0, 0)", et: 1, at: 0, Y: !1 }),
          (this.Fu = new fi()),
          (this.Ut = !0),
          (this.Ie = t),
          (this.We = t.ct()),
  ...
  function xi(t, i, n, h, s, r, e, u, a) {
    ...
    switch (((t.Ke = _), i.position)) {
      case "inBar":
        return (t.p = e.Z(o, a)), void (void 0 !== t.Vt && (t.Vt.p = t.p + d + r + 0.6 * s));
      case "aboveBar":
        return (
          (t.p = e.Z(l, a) - d - h.Ku),
      ...
      case "belowBar":
        return (
          (t.p = e.Z(f, a) + d + h.$u),
          void 0 !== t.Vt && ((t.Vt.p = t.p + d + r + 0.6 * s), (h.$u += 1.2 * s)),
          void (h.$u += _ + r)
        );
    }
    i.position;
  ...
  var Ni = (function () {
        ...
        (t.prototype.je = function () {
          ...
          this.Xu &&
            ((this.it.m = n.map(function (t) {
              return { P: t.time, g: 0, p: 0, Ke: 0, Yu: t.shape, ut: t.color, Uu: t.Uu, qu: t.id, Vt: void 0 };
            })),
            (this.Xu = !1));
          ...
          if (null !== s) {
            ...
            if (null !== r && 0 !== this.it.m.length) {
              ...
              for (var o = this.it.M.from; o < this.it.M.to; o++) {
                ...
                var f = this.it.m[o];
                (f.g = i.tt(l.time)),
                  void 0 !== l.text && l.text.length > 0 && (f.Vt = { Hu: l.text, p: 0, wt: 0, Mt: 0 });
          ...
          if (((t.Y = !1), (i.Y = !1), this.ft.Y())) {
            ...
            if (!u.ha) {
              s && ((t.Vt = this.ea(u, s, e)), (t.Y = 0 !== t.Vt.length)),
                (r || e) && ((i.Vt = this.ua(u, s, r, e)), (i.Y = i.Vt.length > 0));
    ...
    Di = (function () {
      ...
      return (
        ...
        (t.prototype.bn = function () {
          return null === this.Pn ? null : { priceRange: this.Pn.bn(), margins: this.la || void 0 };
        }),
        (t.mn = function (i) {
      ...
      return (
        ...
        (t.prototype.Ha = function (t, i, n) {
          for (var h = null, s = t; s < i; s++) {
            var r = this.xa[s].G[n];
            Number.isNaN(r) || (null === h ? (h = { Ya: r, Ka: r }) : (r < h.Ya && (h.Ya = r), r > h.Ka && (h.Ka = r)));
          }
          return h;
        }),
        ...
        (t.prototype.Ia = function (t) {
          a(!this.ii(), "plot list should not be empty"),
            a(this.xa[this.xa.length - 1].Fs === t.Fs, "last row index should match new row index"),
            this.$a(t),
            this.Sa.delete(t.Fs),
  ...
  function Pi(t, i) {
    return null === t ? i : null === i ? t : { Ya: Math.min(t.Ya, i.Ya), Ka: Math.max(t.Ka, i.Ka) };
  }
  var Fi = (function (t) {
      function i(i, n, h) {
      ...
      return (
        ...
        (i.prototype.rh = function (t) {
          ...
          c(this.Si, t),
            null !== this.ai && void 0 !== t.scaleMargins && this.ai.rh({ scaleMargins: t.scaleMargins }),
        ...
        (i.prototype.H = function (t) {
          ...
          var i = this.it.ka(t);
          return null === i ? null : { F: i.G[3], N: this.bo(), X: this.mo(), $: this.po(t) };
        }),
    ...
    Hi = (function () {
      function t(t) {
        (this.Ut = !0),
          (this.ot = { Y: !1, ut: "", Mt: 0, wt: 0, vl: [], wl: "center", Ml: "center" }),
        ...
        (t.prototype.R = function (t, i) {
          ...
          (h.Y = n.visible),
            h.Y &&
              ...
              (h.wl = n.vertAlign),
              (h.vl = [
                { Vt: n.text, Nt: Ot(n.fontSize, n.fontFamily, n.fontStyle), dl: 1.2 * n.fontSize, bl: 0, Ur: 0 },
              ]));
        }),
        t
      );
    ...
    Ki = (function () {
      ...
      return (
        ...
        (t.prototype.Ll = function (t) {
          if (void 0 !== t)
            if (t > this.gl.length) for (var i = this.gl.length; i < t; i++) this.Ll(i);
        ...
        (t.prototype.Ql = function (t) {
          var i = !1;
          return (
            null !== this.yl && Math.abs(t - this.yl) > 20 && ((this.yl = null), (i = !0)), this.Oo.Hh(t), this.zr(), i
          );
        }),
  ...
  var Xi = (function () {
      ...
      return (
        ...
        (t.prototype._installResolutionListener = function () {
          ...
          (this._resolutionMediaQueryList = t.matchMedia("all and (resolution: " + i + "dppx)")),
  ...
  function Qi(t, i) {
    var n = t.createElement("canvas"),
      h = Ji(n);
    return (
      (n.style.width = i.st + "px"), (n.style.height = i.rt + "px"), (n.width = i.st * h), (n.height = i.rt * h), n
    );
  }
  function tn(t, i) {
  ...
  var hn = (function () {
    ...
    var t =
      ...
      (!!nn && ("ontouchstart" in window || Boolean(window.DocumentTouch && document instanceof window.DocumentTouch)));
      ...
      return (
        ...
        (t.prototype.Yf = function (t) {
          if (!("button" in t) || 0 === t.button) {
            ...
            this.Bf(),
              ...
              this.Pf(i, this.Ef.$f),
              ++this._f,
              this.df && this._f > 1 ? (this.Pf(i, this.Ef.Xf), this.Af()) : this.gf || this.Pf(i, this.Ef.Zf),
              an(t) && (on(t), this.Kf(t), 0 === t.touches.length && (this.Mf = !1));
          }
        }),
          ...
          if (!("button" in t) || 0 === t.button) {
            ...
            (this.kf = function () {
              ...
              an(t) && 1 === t.touches.length
                ...
                : (s.addEventListener("mousemove", n), s.addEventListener("mouseup", h)),
              (this.Df = !0),
              this.Pf(i, this.Ef.Qf),
              this.df || ((this._f = 0), (this.df = setTimeout(this.Af.bind(this), 500)));
          }
        }),
        (t.prototype.Lf = function () {
          ...
          (this.pf = function () {
            ...
            this.Tf.addEventListener("touchstart", this.Jf.bind(this), { passive: !0 }),
            hn || this.Tf.addEventListener("mousedown", this.Jf.bind(this)),
            this.ic(),
            this.Tf.addEventListener("touchmove", function () {}, { passive: !1 });
        }),
        (t.prototype.ic = function () {
          var t = this;
          (void 0 === this.Ef.nc && void 0 === this.Ef.hc && void 0 === this.Ef.sc) ||
      ...
      return (
        ...
        (t.prototype.Hc = function (t) {
          ...
          this.Lc.Ho(h),
            ...
            this.Ec.ct().Bl(),
            this.Pc.rn(function () {
              return { Jc: { Fs: i.Oc, Mt: i.Lc.$c().rt }, Ee: { Fs: i.zc, Mt: i.Ac.$c().rt } };
            });
        }),
      ...
      return (
        ...
        (t.prototype.iv = function (t, i) {
          ...
          if (this.Qc.has(i)) n = o(this.Qc.get(i));
            ...
            (n = { Vt: i, nv: Math.round(Math.max(1, a)), wt: Math.ceil(l * r), Mt: Math.ceil(f * r), hv: c }),
      ...
      return (
        ...
        (t.prototype.kv = function () {
          ...
          var t = 34,
            ...
            h = this.Qt.Vn();
          (n.font = this.pv()),
            h.length > 0 && (t = Math.max(this.uv.Ot(n, h[0].Ln), this.uv.Ot(n, h[h.length - 1].Ln)));
        ...
        (t.prototype.ci = function (t) {
          this.Qt !== t &&
            (null !== this.Qt && this.Qt.Wh().sn(this), (this.Qt = t), t.Wh().Gi(this.qn.bind(this), this));
        }),
        (t.prototype.J = function () {
          return this.Qt;
        }),
    ...
    _n = (function () {
      ...
      return (
        ...
        (t.prototype.Gv = function (i) {
          null !== this.Hv && this.Hv.ol().sn(this),
            (this.Hv = i),
            null !== this.Hv && this.Hv.ol().Gi(t.prototype.Kv.bind(this), this, !0),
            this.Jv();
        }),
        (t.prototype.cv = function () {
          return this.Yv;
        ...
        (t.prototype.If = function (t) {
          if (this.Hv) {
            ...
            if ((this.i_() && this.n_(), !hn)) {
              this.t_(i, n);
              var h = this.Ru(i, n);
              this.ri().zl(h && { Pl: h.Pl, h_: h.h_ }), null !== h && void 0 !== h.gc.s_ && h.gc.s_(i, n);
            }
          }
        }),
        (t.prototype.Zf = function (t) {
          ...
          if (null !== this.Hv) {
            ...
            if (!i.q().ii()) {
              ...
              if (
                ...
                var a = this.Hv.Ti();
                null !== this.Pv || this.u_() || (this.Pv = { x: t.lc, y: t.fc }),
                  null === this.Pv ||
                    (this.Pv.x === t.lc && this.Pv.y === t.fc) ||
                    this.Fv ||
                    (a.ii() || i.nl(this.Hv, a, t.dc), i.Gl(t._c), (this.Fv = !0)),
          ...
          if (0 !== t && null !== this.Hv) {
            if ((t > 1 && this.c_(), null !== this.Ov && this.Ov.Dv(t), null !== this.zv && this.zv.Dv(t), 1 !== t)) {
              ...
              i.save(),
                ...
                this.Hv &&
                  (this.__(i, this.dv.pixelRatio), this.d_(i, this.dv.pixelRatio), this.w_(i, this.dv.pixelRatio)),
                i.restore();
            }
            var n = Gi(this.wv.canvas);
            n.clearRect(0, 0, Math.ceil(this.sv.st * this.wv.pixelRatio), Math.ceil(this.sv.rt * this.wv.pixelRatio)),
        ...
        (t.prototype.Qv = function () {
          if (null !== this.Hv) {
            ...
            t.I().leftPriceScale.visible ||
              null === this.Ov ||
              (this.Xv.removeChild(this.Ov.Kc()), this.Ov.un(), (this.Ov = null)),
              t.I().rightPriceScale.visible ||
                null === this.zv ||
                (this.Zv.removeChild(this.zv.Kc()), this.zv.un(), (this.zv = null));
            var i = t.ct().uf();
            t.I().leftPriceScale.visible &&
              null === this.Ov &&
              ((this.Ov = new cn(this, t.I().layout, i, "left")), this.Xv.appendChild(this.Ov.Kc())),
              t.I().rightPriceScale.visible &&
                null === this.zv &&
                ((this.zv = new cn(this, t.I().layout, i, "right")), this.Zv.appendChild(this.zv.Kc()));
          }
        }),
  ...
  var Mn = (function () {
      ...
      return (
        ...
        (t.prototype.P_ = function () {
          null === this.ae &&
            (this.ae = { Tt: 1, zt: NaN, Et: NaN, Lt: NaN, si: NaN, Dt: 3, Pt: NaN, Nt: "", hi: new ai() });
          var t = this.ae,
            i = this.W_();
          if (t.Nt !== i) {
            var n = this.le();
        ...
        (t.prototype.B_ = function () {
          ...
          i.leftPriceScale.visible ||
            ...
            i.rightPriceScale.visible ||
              null === this.S_ ||
              (this.E_.removeChild(this.S_.Kc()), this.S_.un(), (this.S_ = null));
    ...
    bn = (function () {
      ...
      return (
        ...
        (t.prototype.un = function () {
          ...
          (this.U_ = []),
            l(this.nd).un(),
            null !== this.D_.parentElement && this.D_.parentElement.removeChild(this.D_),
            this.Nl.un(),
            this.Iv.un();
        }),
        ...
        (t.prototype._d = function () {
          ...
          for (
            var v = f + c,
              ...
              w = 0,
              M =
                (null === (t = document.body.ownerDocument.defaultView) || void 0 === t
                  ? void 0
            ...
            var m,
              g = 0;
            (g = b === this.j_.length - 1 ? Math.ceil((_ - w) * M) / M : Math.round(e.qo() * d * M) / M),
              (w += m = Math.max(g, 2)),
              e.Nv(new Zi(o, m)),
              this.ld() && e.f_(n, "left"),
  ...
  function yn(t) {
    return function (i, n, h) {
      return void 0 === (s = h).open && void 0 === s.value ? { P: i, Fs: n } : t(i, n, h);
      var s;
    };
  }
  var kn = { Candlestick: yn(gn), Bar: yn(gn), Area: yn(mn), Histogram: yn(mn), Line: yn(mn) };
  function xn(t) {
    return kn[t];
  }
  function Nn(t) {
    ...
    return (
      ...
      (t.prototype.Bd = function (t, i) {
        ...
        if (void 0 !== h && n.Ds < h.Ds)
          throw new Error("Cannot update oldest data, last time=" + h.Ds + ", new time=" + n.Ds);
  ...
  var Fn = { color: "#FF0000", price: 0, lineStyle: 2, lineWidth: 1, axisLabelVisible: !0, title: "" },
    In = (function () {
      function t(t) {
        this.fa = t;
      }
  ...
  var Rn = (function () {
      ...
      return (
        ...
        (t.prototype.barsInLogicalRange = function (t) {
          ...
          var h = n.Ba(i.ss(), 1),
            ...
            r = l(n.Ta()),
            e = l(n.Hi());
          if (null !== h && null !== s && h.Fs > s.Fs) return { barsBefore: t.from - r, barsAfter: e - t.to };
          var u = {
    ...
    Hn = {
      width: 0,
      height: 0,
      layout: { backgroundColor: "#FFFFFF", textColor: "#191919", fontSize: 11, fontFamily: Vt },
      crosshair: {
        vertLine: {
          color: "#758696",
          width: 1,
  ...
  var nh = (function () {
    ...
    return (
      ...
      (t.prototype.tw = function (t) {
        return { top: { index: t.Jc.Fs, height: t.Jc.Mt }, bottom: { index: t.Ee.Fs, height: t.Ee.Mt } };
      }),
      t
    );
  })();
