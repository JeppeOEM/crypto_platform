...
STRAT_PARAMS = {
    "dynamic": {
        "RSI_15": {"name": "rsi sell val", "type": int, "min": 15, "max": 55}
...
def get_library():
    ...
    lib.Sma_new.argtypes = [c_char_p, c_char_p,
                            c_char_p, c_longlong, c_longlong]
    ...
    lib.Psar_new.argtypes = [c_char_p, c_char_p,
                             c_char_p, c_longlong, c_longlong]
    lib.Psar_execute_backtest.restype = c_void_p
    lib.Psar_execute_backtest.argtypes = [
